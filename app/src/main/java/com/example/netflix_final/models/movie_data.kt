...
data class MovieModel(val title: String, val description: String, val genre: List<GenreModel>,  val year: Year, val duration: Duration, val image: String)
...
val movieList: MutableList<MovieModel> = mutableListOf(
    ...
    MovieModel(
        ...
        year = Year.of(2021),
        duration = Duration.ofMinutes(163),
    ...
    MovieModel(
        ...
        year = Year.of(2019),
        duration = Duration.ofMinutes(132),
