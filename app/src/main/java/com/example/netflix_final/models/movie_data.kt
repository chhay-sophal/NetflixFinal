...
val movieList1: MutableList<MovieModel> = mutableListOf(
    ...
    MovieModel("Captain America: The Winter Soldier", "As Steve Rogers struggles to embrace his role in the modern world, he teams up with a fellow Avenger and S.H.I.E.L.D agent, Black Widow, to battle a new threat from history: an assassin known as the Winter Soldier.", Year.of(2014), Duration.ofMinutes(136), "https://www.themoviedb.org/t/p/original/qbUmbVOVVjCGQbSKpsFV5tmZjX6.jpg"),
    MovieModel("Guardians of the Galaxy", "A group of intergalactic criminals must pull together to stop a fanatical warrior with plans to purge the universe.", Year.of(2014), Duration.ofMinutes(121), "https://www.themoviedb.org/t/p/original/y31QB9kn3XSudA15tV7UWQ9XLuW.jpg"),
    MovieModel("Deadpool", "A wisecracking mercenary gets experimented on and becomes immortal but ugly, and sets out to track down the man who ruined his looks.", Year.of(2016), Duration.ofMinutes(108), "https://www.themoviedb.org/t/p/original/inVq3FRqcYIRl2la8iZikYYxFNR.jpg"),
    MovieModel("The Incredibles", "A family of undercover superheroes, while trying to live the quiet suburban life, are forced into action to save the world.", Year.of(2004), Duration.ofMinutes(115), "https://www.themoviedb.org/t/p/original/hhjMv8IXUxcApAaV8eDdpdoQxj.jpg"),
    MovieModel("Thor: Ragnarok", "Imprisoned on the planet Sakaar, Thor must race against time to return to Asgard and stop Ragnarök, the destruction of his world, at the hands of the powerful and ruthless villain Hela.", Year.of(2017), Duration.ofMinutes(131), "https://www.themoviedb.org/t/p/original/rzRwTcFvttcN1ZpX2xv4j3tSdJu.jpg"),
    MovieModel("X-Men: Days of Future Past", "The X-Men send Wolverine to the past in a desperate effort to change history and prevent an event that results in doom for both humans and mutants.", Year.of(2014), Duration.ofMinutes(131), "https://www.themoviedb.org/t/p/original/g51t83hrgPf3Y6sHO8nWyFVspgV.jpg"),
    MovieModel("Shazam!", "A newly fostered young boy in search of his mother instead finds unexpected super powers and soon gains a powerful enemy.", Year.of(2019), Duration.ofMinutes(132), "https://www.themoviedb.org/t/p/original/xnopI5Xtky18MPhK40cZAGAOVeV.jpg"),
    MovieModel("Doctor Strange", "While on a journey of physical and spiritual healing, a brilliant neurosurgeon is drawn into the world of the mystic arts.", Year.of(2016), Duration.ofMinutes(115), "https://www.themoviedb.org/t/p/original/4PiiNGXj1KENTmCBHeN6Mskj2Fq.jpg"),
    MovieModel("Ant-Man", "Armed with a super-suit with the astonishing ability to shrink in scale but increase in strength, cat burglar Scott Lang must embrace his inner hero and help his mentor, Dr. Hank Pym, plan and pull off a heist that will save the world.", Year.of(2015), Duration.ofMinutes(117), "https://www.themoviedb.org/t/p/original/D6e8RJf2qUstnfkTslTXNTUAlT.jpg"),
    MovieModel("Aquaman", "Arthur Curry, the human-born heir to the underwater kingdom of Atlantis, goes on a quest to prevent a war between the worlds of ocean and land.", Year.of(2018), Duration.ofMinutes(143), "https://www.themoviedb.org/t/p/original/9QusGjxcYvfPD1THg6oW3RLeNn7.jpg"),
    ...
    MovieModel("Iron Man 3", "When Tony Stark's world is torn apart by a formidable terrorist called the Mandarin, he starts an odyssey of rebuilding and retribution.", Year.of(2013), Duration.ofMinutes(130), "https://www.themoviedb.org/t/p/original/7XiGqZE8meUv7L4720lU6uvH2bL.jpg"),
    MovieModel("Batman Begins", "After training with his mentor, Batman begins his fight to free crime-ridden Gotham City from corruption.", Year.of(2005), Duration.ofMinutes(140), "https://www.themoviedb.org/t/p/original/hBd9boVkvW1k8W8thnV5UdLhBVY.jpg"),
